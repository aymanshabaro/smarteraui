...
export const AVATARS = [
    { src: "/demo/avatars/avatar-01.svg", alt: "Olivia Rhye", name: "Olivia Rhye", initials: "OR", email: "olivia@proper.example", username: "@olivia" },
    { src: "/demo/avatars/avatar-02.svg", alt: "Phoenix Baker", name: "Phoenix Baker", initials: "PB", email: "phoenix@proper.example", username: "@phoenix" },
    { src: "/demo/avatars/avatar-03.svg", alt: "Lana Steiner", name: "Lana Steiner", initials: "LS", email: "lana@proper.example", username: "@lana" },
    { src: "/demo/avatars/avatar-04.svg", alt: "Demi Wilkinson", name: "Demi Wilkinson", initials: "DW", email: "demi@proper.example", username: "@demi" },
    { src: "/demo/avatars/avatar-05.svg", alt: "Candice Wu", name: "Candice Wu", initials: "CW", email: "candice@proper.example", username: "@candice" },
    { src: "/demo/avatars/avatar-06.svg", alt: "Natali Craig", name: "Natali Craig", initials: "NC", email: "natali@proper.example", username: "@natali" },
    { src: "/demo/avatars/avatar-07.svg", alt: "Drew Cano", name: "Drew Cano", initials: "DC", email: "drew@proper.example", username: "@drew" },
    { src: "/demo/avatars/avatar-08.svg", alt: "Orlando Diggs", name: "Orlando Diggs", initials: "OD", email: "orlando@proper.example", username: "@orlando" },
    { src: "/demo/avatars/avatar-09.svg", alt: "Andi Lane", name: "Andi Lane", initials: "AL", email: "andi@proper.example", username: "@andi" },
    { src: "/demo/avatars/avatar-10.svg", alt: "Kate Morrison", name: "Kate Morrison", initials: "KM", email: "kate@proper.example", username: "@kate" },
    { src: "/demo/avatars/avatar-11.svg", alt: "Koray Okumus", name: "Koray Okumus", initials: "KO", email: "koray@proper.example", username: "@koray" },
    { src: "/demo/avatars/avatar-12.svg", alt: "Ava Wright", name: "Ava Wright", initials: "AW", email: "ava@proper.example", username: "@ava" },
] as const;
