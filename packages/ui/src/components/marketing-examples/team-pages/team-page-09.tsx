...
import { HeaderBlogPostsWithFooter } from "../../marketing/header-navigations/header-blog-posts-with-footer";
...
import { TeamSectionSimple02 } from "../../marketing/team-sections/team-section-simple-02";
