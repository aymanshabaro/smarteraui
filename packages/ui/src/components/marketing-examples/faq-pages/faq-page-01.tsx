...
/**
 * FAQ page 01 — a floating header over a centered, searchable FAQ hero, a three-column grid of
 * icon-led answers closed by a "still have questions" card, a trial CTA and a large link footer.
 */
