...
const trades: Trade[] = [
    { id: "trade-01", ticker: "TSLA BUY", company: "Tesla, Inc.", amount: "$30,021.23", date: "Jan 13, 2026", status: "processing", person: avatar(0) },
    { id: "trade-02", ticker: "MTCH SELL", company: "Match Group, Inc.", amount: "$10,045.00", date: "Jan 13, 2026", status: "success", person: avatar(1) },
    { id: "trade-03", ticker: "DDOG BUY", company: "Datadog Inc.", amount: "$40,132.16", date: "Jan 13, 2026", status: "success", person: avatar(2) },
    {
        id: "trade-04",
        ticker: "ARKG BUY",
    ...
    { id: "trade-05", ticker: "SQ BUY", company: "Square, Inc.", amount: "$18,221.30", date: "Jan 12, 2026", status: "success", person: avatar(4) },
    { id: "trade-06", ticker: "MSTR SELL", company: "MicroStrategy Inc.", amount: "$24,118.18", date: "Jan 12, 2026", status: "success", person: avatar(5) },
];
...
/** Informational page 02 — trade history with a secondary header nav, button-group filters and a boxed filter bar. */
export const Informational02 = () => (
    <div className="bg-primary flex flex-col">
        <AppHeader activeUrl="/dashboard/trade-history" subItems={subNavItems} actions="upgrade" />
        ...
        <main className="bg-primary min-w-0 flex-1 pt-8 pb-16 lg:pt-12 lg:pb-24">
            ...
            <div className="max-w-container mx-auto flex flex-col gap-6 px-4 lg:px-8">
                <div className="ring-secondary lg:bg-secondary hidden ring-1 ring-inset lg:block lg:rounded-xl lg:px-4 lg:py-3">
