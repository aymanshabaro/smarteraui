...
export default {
    title: "Page examples/Dashboards with header navigation",
    decorators: [
        (Story: FC) => (
...
export const DashboardWithHeaderNavigationExample = () => <Demos.DashboardWithHeaderNavigationExample />;
DashboardWithHeaderNavigationExample.storyName = "Dashboard with header navigation example";
