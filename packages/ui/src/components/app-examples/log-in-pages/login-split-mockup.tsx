...
// frame is duplicated by `login-split-mockup-quote` and by the marketing hero screen mockups.
const styles = sortCx({
    mockup: {
        outer: "bg-primary ring-secondary_alt rounded-[9.03px] p-[0.9px] shadow-lg ring-[0.56px] md:rounded-[26.95px] md:p-[3.5px] md:ring-[1.68px]",
        middle: "bg-primary shadow-modern-mockup-inner-md md:shadow-modern-mockup-inner-lg rounded-[7.9px] p-0.5 md:rounded-[23.58px] md:p-1",
...
/** Split log in page with a narrow form column and an oversized, bezelled app screenshot alongside. */
                ...
                <div className={styles.mockup.middle}>
                    <div className={styles.mockup.screen}>
                        <img
                            ...
                            className="max-h-168.5 max-w-none object-cover object-left-top"
                        />
                    </div>
                </div>
            </div>
