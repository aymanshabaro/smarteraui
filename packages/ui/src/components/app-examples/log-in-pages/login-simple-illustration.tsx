...
/** Log in page that swaps the logo lockup for a cloud illustration badged with a sign-in glyph. */
        ...
        <div className="mx-auto flex w-full flex-col gap-8 sm:max-w-90">
            <div className="flex flex-col items-center gap-8 text-center">
                <div className="relative">
                    <Illustration type="cloud" size="sm" className="relative z-10 h-29.5 w-38">
                        <LogIn04 className="size-6" />
                    </Illustration>
                </div>
