...
/** Split log in page with an inset, rounded portrait panel and a banded review at its foot. */
export const LoginSplitQuoteImage03 = () => {
    ...
    return (
        <section className="bg-primary grid min-h-screen grid-cols-1 lg:grid-cols-2">
            ...
            <div className="relative hidden py-6 pe-6 lg:flex">
                <div className="relative flex flex-1 flex-col items-start justify-end overflow-hidden rounded-[20px]">
                    ...
                    <figure className="relative z-10 bg-linear-to-t from-black/40 to-black/0 pt-24">
                        <div className="bg-primary/25 flex h-max flex-col gap-8 overflow-hidden border-t border-white/30 px-8 py-8 backdrop-blur-md">
