...
export default {
    title: "Page examples/Settings pages with sidebar navigation",
    decorators: [
        (Story: FC) => (
...
export const SettingsPageWithSidebarNavigationExample = () => <Demos.SettingsPageWithSidebarNavigationExample />;
SettingsPageWithSidebarNavigationExample.storyName = "Settings page with sidebar navigation example";
