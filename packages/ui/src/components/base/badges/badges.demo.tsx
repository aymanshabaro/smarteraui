...
export const WithAvatar = () => {
    return (
        <div className="flex flex-col items-start gap-4">
            {(Object.keys(filledColors) as BadgeColors[]).map((color) => (
                <div key={color} className="flex items-start gap-4">
                    <BadgeWithImage color={color} size="sm" imgSrc={avatar(0).src}>
                        Label
                    </BadgeWithImage>
                    <BadgeWithImage color={color} size="md" imgSrc={avatar(0).src}>
                        Label
                    </BadgeWithImage>
                    <BadgeWithImage color={color} size="lg" imgSrc={avatar(0).src}>
                        Label
                    </BadgeWithImage>
                </div>
            ))}
...
export const WithAvatarBadgeColor = () => {
    return (
        <div className="flex flex-col items-start gap-4">
            {(Object.keys(filledColors) as BadgeColors[]).map((color) => (
                <div key={color} className="flex items-start gap-4">
                    <BadgeWithImage color={color} size="sm" imgSrc={avatar(0).src} type="color">
                        Label
                    </BadgeWithImage>
                    <BadgeWithImage color={color} size="md" imgSrc={avatar(0).src} type="color">
                        Label
                    </BadgeWithImage>
                    <BadgeWithImage color={color} size="lg" imgSrc={avatar(0).src} type="color">
                        Label
                    </BadgeWithImage>
                </div>
            ))}
...
export const WithAvatarBadgeModern = () => {
    return (
        <div className="flex flex-col items-start gap-4">
            <div className="flex items-start gap-4">
                <BadgeWithImage color="gray" size="sm" imgSrc={avatar(0).src} type="modern">
                    Label
                </BadgeWithImage>
                <BadgeWithImage color="gray" size="md" imgSrc={avatar(0).src} type="modern">
                    Label
                </BadgeWithImage>
                <BadgeWithImage color="gray" size="lg" imgSrc={avatar(0).src} type="modern">
                    Label
                </BadgeWithImage>
            </div>
        </div>
...
export const ColorWithIconLeading = () => {
    return (
        <div className="flex flex-col items-start gap-4">
            {(Object.keys(filledColors) as BadgeColors[]).map((color) => (
                <div key={color} className="flex items-start gap-4">
...
export const ModernWithIconLeading = () => {
    return (
        <div className="flex flex-col items-start gap-4">
            {(Object.keys(filledColors) as BadgeColors[]).map((color) => (
                <div key={color} className="flex items-start gap-4">
...
export const ColorWithIconTrailing = () => {
    return (
        <div className="flex flex-col items-start gap-4">
            {(Object.keys(filledColors) as BadgeColors[]).map((color) => (
                <div key={color} className="flex items-start gap-4">
...
export const ModernWithIconTrailing = () => {
    return (
        <div className="flex flex-col items-start gap-4">
            <div className="flex items-start gap-4">
...
export const ColorWithIconOnly = () => {
    return (
        <div className="flex flex-col items-start gap-4">
            {(Object.keys(filledColors) as BadgeColors[]).map((color) => (
                <div key={color} className="flex items-start gap-4">
...
export const ModernWithIconOnly = () => {
    return (
        <div className="flex flex-col items-start gap-4">
            <div className="flex items-start gap-4">
                <button aria-label="Add" className="outline-focus-ring cursor-pointer rounded-md focus-visible:outline-2 focus-visible:outline-offset-2">
