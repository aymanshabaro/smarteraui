...
export const FileTrigger = (props: FileTriggerProps) => {
    ...
    // eslint-disable-next-line react-hooks/refs -- `inputRef.current` is only read once this handler runs (on click), never during render.
    ...
    return (
        <>
            ...
            <input
                ...
                // @ts-expect-error -- `webkitdirectory` is a non-standard attribute not present in React's DOM typings.
