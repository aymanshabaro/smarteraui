            ...
            {(state) => (
                ...
                >
                    ...
                    <div className={cx("flex w-full min-w-0 flex-1 flex-wrap", sizes[size].textContainer)}>
                        <AriaText slot="label" className={cx("text-primary truncate font-medium whitespace-nowrap", sizes[size].text)}>
                            {label || (typeof children === "function" ? children(state) : children)}
                        </AriaText>

                        {supportingText && (
                            <AriaText slot="description" className={cx("text-tertiary whitespace-nowrap", sizes[size].text)}>
                                {supportingText}
                            </AriaText>
                        )}
                    </div>
