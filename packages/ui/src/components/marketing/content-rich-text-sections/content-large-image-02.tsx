...
/** A centered header with a byline, a contained hero image and a centered pull quote. */
    ...
    <div className="bg-primary">
        <div className="max-w-container mx-auto px-4 py-16 md:px-8 md:py-24">
            <div className="mx-auto flex w-full max-w-180 flex-col items-center text-center">
                <span className="text-brand-secondary md:text-md text-sm font-semibold">Design</span>
            ...
            <img className="mx-auto mt-12 h-60 w-full object-cover md:mt-16 md:h-140 md:max-w-5xl" src={IMAGES.landscape[3].src} alt="" />
        </div>
            ...
            <div className="mx-auto max-w-prose md:max-w-180">
                <div className="prose-centered-quote prose md:prose-lg mx-auto">
                    <p className="lead">
                        ...
                        Here is the structure we use to do both without doubling the length.
                    </p>
                    ...
                    <p>
                        ...
                        nothing. Everything after that slide exists to support the answer.
                    </p>

                    <figure>
                        <img className="h-86 md:h-180" src={IMAGES.square[0].src} alt="" />
                        <figcaption>
                            <span>
