...
/** Four icon-led questions beside a full-bleed customer photo. */
    ...
    <section className="bg-primary py-16 md:py-24">
        <div className="max-w-container mx-auto px-4 md:px-8">
            <div className="flex w-full flex-col lg:w-192">
                ...
                <h2 className="text-display-sm text-primary md:text-display-md mt-3 font-semibold">Frequently asked questions</h2>
            ...
            <div className="mt-12 grid grid-cols-1 gap-12 md:mt-16 md:gap-24 lg:grid-cols-2 lg:items-center">
                <dl className="grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-12 lg:grid-cols-1 lg:py-6">
                    {faqs.map((faq) => (
                        <div key={faq.question} className="relative flex flex-col ps-14 md:ps-16">
                            <dt className="text-primary pt-1.5 text-lg font-semibold md:pt-2.5">
