...
/** The plain three-column question grid on the permanently branded section background. */
                ...
                <dl className="grid w-full grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 md:gap-y-16 lg:grid-cols-3">
                    {faqs.map((faq) => (
                        <div key={faq.question} className="flex max-w-sm flex-col">
                            <dt className="text-md text-primary_on-brand font-semibold">{faq.question}</dt>
