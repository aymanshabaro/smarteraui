...
const styles = sortCx({
    ...
    trigger:
        "flex w-full cursor-pointer gap-2 rounded-md text-start outline-focus-ring select-none focus-visible:outline-2 focus-visible:outline-offset-2 md:flex-row md:gap-4",
...
/** A two-column layout with the heading beside an accordion of filled cards. */
