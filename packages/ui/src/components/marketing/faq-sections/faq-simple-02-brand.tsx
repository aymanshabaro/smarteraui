...
/** The left-aligned icon-led FAQ grid on the permanently branded section background. */
export const FaqSimple02Brand = () => (
    <section className="bg-brand-section py-16 md:py-24">
        <div className="max-w-container mx-auto px-4 md:px-8">
            <div className="flex w-full max-w-3xl flex-col">
                <h2 className="text-display-sm text-primary_on-brand md:text-display-md font-semibold">FAQs</h2>
                ...
                <dl className="grid w-full grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 md:gap-y-16 lg:grid-cols-3">
                    {faqs.map((faq) => (
                        <div key={faq.question} className="flex max-w-sm flex-col">
                            <dt className="text-primary_on-brand flex flex-col items-start text-lg font-semibold">
            ...
            <div className="bg-brand-section_subtle mt-12 flex flex-col items-start justify-between gap-6 rounded-2xl px-5 py-8 md:mt-16 md:flex-row md:gap-8 md:p-8">
