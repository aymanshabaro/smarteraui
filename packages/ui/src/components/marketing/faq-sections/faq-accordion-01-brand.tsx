...
const styles = sortCx({
    item: "not-first:-mt-px not-first:border-t not-first:border-brand_alt not-first:pt-6",
    trigger:
...
/** The centered divided accordion on the permanently branded section background. */
export const FaqAccordion01Brand = () => (
    <section className="bg-brand-section py-16 md:py-24">
        <div className="max-w-container mx-auto px-4 md:px-8">
            ...
            <div className="bg-brand-section_subtle mt-12 flex flex-col items-center gap-6 rounded-2xl px-6 py-8 text-center md:mt-16 md:gap-8 md:pt-8 md:pb-10">
