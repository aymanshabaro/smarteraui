...
/**
 * Hero screen mockup 06 — a split hero whose laptop capture bleeds off the right edge of the
 * viewport from `lg` up.
 */
            ...
            <div className="max-w-container mx-auto grid grid-cols-1 items-center justify-items-center gap-16 px-4 md:px-8 lg:grid-cols-2 lg:justify-items-start">
                ...
                <div className="relative lg:h-full lg:min-h-177">
                    <img
                        ...
                        alt={IMAGES.landscape[6].alt}
                        className="inset-0 h-auto w-full max-w-none object-cover md:h-90 md:w-auto lg:absolute lg:h-full lg:object-left"
                    />
                </div>
            </div>
        </section>
