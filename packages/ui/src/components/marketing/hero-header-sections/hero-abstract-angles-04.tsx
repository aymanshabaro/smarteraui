...
/**
 * Hero abstract angles 04 — the tinted stripe-band hero, closed out by a wide laptop screen
 * mockup instead of a video.
 */
            ...
            <div className="relative pb-16 md:pb-0">
                <div className="max-w-container mx-auto w-full px-4 md:px-8">
                    <div className="mx-auto w-full max-w-5xl md:h-80 lg:h-104">
                        <img src={IMAGES.landscape[6].src} alt={IMAGES.landscape[6].alt} className="size-full object-cover object-top" />
                    </div>
                </div>
            </div>
        </section>
