...
const styles = sortCx({
    mockup: {
        outer: "ring-utility-neutral-300 bg-primary size-full rounded-[9.03px] p-[0.9px] shadow-lg ring-[0.56px] ring-inset md:rounded-[28px] md:p-[3.5px] md:ring-[1.75px]",
        middle: "bg-primary shadow-modern-mockup-inner-md md:shadow-modern-mockup-inner-lg size-full rounded-[7.9px] p-0.5 md:rounded-[24.5px] md:p-1",
        screen: "bg-utility-neutral-50 ring-utility-neutral-200 relative size-full overflow-hidden rounded-[6.77px] ring-[0.56px] md:rounded-[21px] md:ring-[1.75px]",
    },
});

/** Centred hero on a grid backdrop with a full-width, bezelled app screenshot below the fold line. */
export const HeroScreenMockup01 = () => (
    <div className="bg-secondary relative overflow-hidden">
        ...
        <BackgroundPattern pattern="grid" size="md" className="absolute top-0 left-1/2 z-0 max-w-none -translate-x-1/2 md:hidden" />
