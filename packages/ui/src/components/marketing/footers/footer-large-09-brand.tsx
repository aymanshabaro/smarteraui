...
/**
 * The brand-background twin of `FooterLarge09`: a centred call-to-action above six link
 * columns, closed by a divider carrying the logo and the copyright line.
 */
export const FooterLarge09Brand = () => {
    return (
