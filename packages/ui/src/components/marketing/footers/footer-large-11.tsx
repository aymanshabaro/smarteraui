...
/** Centred call-to-action above a single-row navigation, app-store badges and a social bar. */
export const FooterLarge11 = () => (
    <footer className="bg-primary py-12 md:pt-16">
        <div className="max-w-container mx-auto px-4 md:px-8">
            <div className="border-secondary flex flex-col items-center border-b pb-8 text-center md:pb-16">
                <h2 className="text-primary text-display-xs md:text-display-sm font-semibold">No long-term contracts. No catches. Simple.</h2>
                <p className="text-tertiary text-md mt-2 md:mt-4 md:text-xl">Start your 30-day free trial. Cancel anytime.</p>
