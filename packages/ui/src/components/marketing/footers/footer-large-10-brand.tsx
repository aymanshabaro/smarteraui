...
/**
 * A brand footer that opens with a trial call-to-action row, then a logo-and-mission column
 * beside five link columns, closed by the copyright and social row.
 */
