...
/**
 * Grid line names are the only way to pin each stripe to the page gutters, and named lines
 * cannot be expressed as Tailwind utilities, so the track definition stays in a style object.
 */
...
/** Centered hero on a brand tint, with skewed colour stripes running behind a laptop mockup. */
