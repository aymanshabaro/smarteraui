...
const styles = sortCx({
    /** The nav sits on the brand tint, so its links and chevrons switch to the brand foreground tokens. */
    header: [
    ...
    /** One skewed stripe of the angled band behind the mockup. */
    stripes: [
        "-skew-y-[7deg]",
...
/** The named grid the angled stripes are placed on. */
const stripeGrid = {
...
/**
 * Hero abstract angles 03 — centered copy on a brand tint, a band of skewed brand
 * stripes behind the fold, and the product screenshot overlapping both.
 */
                ...
                <div className="max-w-container mx-auto w-full px-4 md:px-8">
                    <div className="mx-auto w-full max-w-5xl">
                        <img
                            ...
                            className="ring-screen-mockup-border md:shadow-3xl mx-auto aspect-3/2 max-w-full rounded object-cover object-top shadow-xl ring-4 md:rounded-xl md:ring-6"
                        />
                    </div>
                </div>
            </div>
