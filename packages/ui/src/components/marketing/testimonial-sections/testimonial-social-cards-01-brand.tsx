...
const reviews = [
    ...
    {
        logo: LOGOS[1],
        quote: "Smartera has become an essential part of our design process. It speeds up our workflow and ensures every project starts with a solid foundation.",
        author: AVATARS[4],
        role: `COO, ${LOGOS[1].name}`,
    },
    {
        logo: LOGOS[2],
        quote: "Every project starts with Smartera, and it's made a huge difference in our output. It's a game-changer for our design team.",
        author: AVATARS[7],
