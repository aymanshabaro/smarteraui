...
const styles = sortCx({
    ...
    /** The frosted panel that floats over the bottom of each portrait. */
    panel: "flex cursor-auto flex-col gap-6 rounded-xl bg-primary/30 px-4 py-6 ring-1 ring-alpha-white/30 backdrop-blur-md ring-inset md:rounded-2xl md:p-5",
});
...
/** A draggable row of portraits, each with a rounded frosted caption card. */
