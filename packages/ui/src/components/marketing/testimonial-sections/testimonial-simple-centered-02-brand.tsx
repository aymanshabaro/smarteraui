...
/** The logo-led centered quote on the brand-colored section background. */
    ...
    <section className="bg-brand-section py-16 md:py-24">
        <div className="max-w-container mx-auto px-4 md:px-8">
            <figure className="flex w-full shrink-0 snap-start flex-col gap-8 text-center">
                ...
                <img alt={review.logo.name} src={review.logo.src} className="h-10 self-center object-contain opacity-85 invert" />

                <blockquote className="text-display-sm md:text-display-lg text-primary_on-brand font-medium text-balance">{review.quote}</blockquote>
