...
const reviews = [
    { author: AVATARS[6], quote: "We've been using Smartera to kick start every new project and can't imagine working without it." },
    { author: AVATARS[9], quote: "From concept to completion, Smartera helps us deliver outstanding designs faster than ever." },
    { author: AVATARS[11], quote: "Every project starts with Smartera which has 10x'd our output. It saves us time while keeping the quality top-notch." },
    { author: AVATARS[2], quote: "Smartera has quickly become our go-to resource for every design project. The results are consistently amazing." },
    { author: AVATARS[7], quote: "Smartera offers exactly what we need to get started quickly. It's helped us cut down on design time significantly!" },
    { author: AVATARS[3], quote: "Smartera offers everything we need to get started on UI projects quickly. We go from zero to one, insanely fast." },
] as const;
