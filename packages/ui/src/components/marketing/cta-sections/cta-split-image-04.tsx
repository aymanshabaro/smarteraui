        ...
        <div className="max-w-container mx-auto px-4 md:px-8">
            <div className="bg-brand-section flex flex-col overflow-hidden rounded-2xl shadow-xl md:flex-row md:items-center md:rounded-3xl">
                <div className="flex flex-1 flex-col px-6 pt-10 pb-12 lg:p-16">
                    ...
                    <p className="text-tertiary_on-brand mt-4 text-lg md:mt-5 md:text-xl">Join over 4,000+ startups already growing with Smartera.</p>
                ...
                <img src={IMAGES.square[0].src} alt="Smartera customer at work" className="h-70 w-full object-cover md:h-100 md:w-95 lg:w-120" />
            </div>
        </div>
    </section>
);
