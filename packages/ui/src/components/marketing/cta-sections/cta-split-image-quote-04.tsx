...
const reviews = [
    {
        quote: "We've really sped up our workflow using Smartera.",
        name: AVATARS[9].name,
    ...
    {
        quote: "Onboarding a new designer used to take a fortnight. It now takes an afternoon.",
        name: AVATARS[7].name,
        company: "Analytics Platform",
        role: `Head of Design, ${LOGOS[4].name}`,
        image: IMAGES.square[3],
    },
] as const;

/** A left-aligned CTA beside a photo whose frosted footer panel cycles through customer quotes. */
export const CtaSplitImageQuote04 = () => {
    ...
    return (
        <section className="bg-primary py-16 lg:py-24">
            <div className="max-w-container mx-auto grid w-full grid-cols-1 gap-x-16 gap-y-12 px-4 md:px-8 lg:grid-cols-2 lg:items-center">
                ...
                <div className="relative h-170 w-full overflow-hidden lg:order-first lg:h-180">
                        ...
                        <figure className="border-alpha-white/30 bg-primary/30 absolute inset-x-0 bottom-0 flex flex-col border-t px-5 pt-6 pb-8 backdrop-blur-[10px] md:p-8">
                            ...
                            <figcaption className="mt-2 flex flex-col justify-between gap-5 md:mt-3 md:flex-row md:gap-3">
                                <div className="flex flex-col gap-0.5 md:gap-1">
                                    ...
                                    <p className="text-sm font-medium text-white">{review.role}</p>
                                </div>
