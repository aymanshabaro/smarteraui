...
/** Two offices on a muted band, with an embedded map overlapping the band from below. */
            ...
            <div className="max-w-container mx-auto px-4 md:px-8">
                <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-24">
                    <div className="flex w-full max-w-3xl flex-col">
                        ...
                        <h2 className="text-display-sm text-primary md:text-display-md mt-3 font-semibold">Our locations</h2>
                        <p className="text-tertiary mt-4 text-lg md:mt-5 md:text-xl">Come visit our friendly team at one of our offices.</p>
                    </div>
                        ...
                        {offices.map((office) => (
                            <li key={office.city} className="flex items-start gap-4">
                                ...
                                <div className="pt-1.5 md:pt-2.5">
                                    ...
                                    <p className="text-md text-tertiary mt-1">{office.address}</p>
                                </div>
                            </li>
                        ))}
                    </ul>
