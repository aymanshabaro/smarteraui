...
/** A consent banner with a verified icon, a policy link and a decline / allow action pair. Brand palette, floating card layout. */
export const BannerDualActionBrand = () => (
    <section className="border-brand_alt bg-brand-section_subtle relative mx-2 mb-4 flex flex-col gap-4 rounded-xl border-t p-4 shadow-lg md:m-0 md:flex-row md:items-center md:gap-3 md:border-t-0 md:border-b md:py-3 md:ps-5 md:pe-3">
