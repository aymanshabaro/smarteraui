...
/** A newsletter banner with a featured icon, supporting copy and an inline email capture form. Brand palette, floating card layout. */
export const BannerTextFieldBrand = () => (
    <section className="border-brand_alt bg-brand-section_subtle relative mx-2 mb-4 flex flex-col gap-4 rounded-xl border-t p-4 shadow-lg md:m-0 md:flex-row md:items-center md:gap-3 md:border-t-0 md:border-b md:p-3">
        <div className="flex flex-1 items-center gap-3 md:w-0">
            <FeaturedIcon icon={Mail01} size="md" color="brand" theme="dark" className="hidden md:flex" />
            ...
            <div className="flex flex-col gap-0.5 overflow-auto">
                ...
                <p className="text-tertiary_on-brand text-sm md:truncate">Be the first to hear about new components, updates, and design resources.</p>
            </div>
        </div>
        ...
        <div className="flex gap-2">
            <Form className="flex flex-1 flex-col gap-3 md:w-90 md:flex-row md:gap-3">
                ...
                <Button type="submit" size="sm" color="secondary" className="shadow-xs! ring-0">
                    Subscribe
                </Button>
            </Form>
