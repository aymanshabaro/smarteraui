...
import { ChartBreakoutSquare, Command, MessageChatCircle, MessageHeartCircle, MessageSmileCircle, Zap } from "@smarteraui/icons";
...
/** The centered six-up feature grid on a brand-colored section background. */
