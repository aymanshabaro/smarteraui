...
/** A brand-section subscribe header with a featured post overlapping it above a tagged post grid. */
export const BlogHeaderFeaturedPost04 = () => (
    <div className="bg-primary">
        <section className="bg-brand-section pt-32 pb-32 md:pt-24 md:pb-40">
            <div className="max-w-container mx-auto px-4 md:px-8">
                <div className="mx-auto flex w-full max-w-3xl flex-col items-center text-center">
                    <span className="text-secondary_on-brand md:text-md text-sm font-semibold">Blog</span>
                    <h2 className="text-display-md text-primary_on-brand md:text-display-lg mt-3 font-semibold">Resource library</h2>
                    ...
                    <form className="mt-8 grid w-full grid-cols-1 items-start gap-4 sm:mt-12 sm:w-auto sm:grid-cols-[335px_max-content]">
                        <div className="flex flex-col gap-1.5 text-start">
                            ...
                            <span className="text-tertiary_on-brand flex w-full text-sm">
        ...
        <main className="max-w-container mx-auto -mt-16 flex w-full flex-col gap-y-12 px-4 pb-16 md:-mt-24 md:gap-y-16 md:px-8 md:pb-24">
