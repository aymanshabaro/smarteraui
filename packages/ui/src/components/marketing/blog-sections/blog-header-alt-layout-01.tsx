...
const FeaturedPostCard = ({ post }: { post: Post }) => (
    <li className="flex flex-col gap-6 md:gap-8 lg:col-span-2 lg:mb-4 lg:flex-row">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start xl:gap-8">
            <a href={post.href} tabIndex={-1} className="shrink-0 overflow-hidden">
                <img src={post.image.src} alt={post.title} className="aspect-[1.5] w-full object-cover lg:h-103 lg:w-180 xl:w-206" />
            </a>
...
/** A subscribe header above a grid whose first article spans the full width on large screens. */
