        ...
        <article className="flex flex-col gap-4 xl:flex-row xl:items-start">
            ...
            >
                <img
                    src={post.image.src}
                    alt={post.title}
                    className="aspect-[1.5] w-full object-cover transition duration-100 ease-linear hover:scale-105 xl:w-screen xl:max-w-93.5"
                />
            </a>
...
/** A centered subscribe header above a single, narrow column of horizontal blog cards. */
export const BlogHeaderAltLayout04 = () => (
    <div className="bg-primary">
        <section className="bg-primary py-16 md:py-24">
            <div className="max-w-container mx-auto px-4 md:px-8">
                <div className="mx-auto flex w-full max-w-3xl flex-col items-center text-center">
                    ...
                    <h2 className="text-display-md text-primary md:text-display-lg mt-3 font-semibold">Smartera blog</h2>
        ...
        <section className="max-w-container bg-primary mx-auto flex w-full flex-col gap-12 px-4 pb-16 md:gap-16 md:px-8 md:pb-24">
