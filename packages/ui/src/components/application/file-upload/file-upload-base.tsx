...
import { CheckCircle, Trash01, UploadCloud02, XCircle } from "@smarteraui/icons";
        ...
        >
            ...
            <div className="flex min-w-0 flex-1 flex-col items-start">
                <div className="flex w-full max-w-full min-w-0 flex-1">
                    <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-0.5 flex items-center gap-2">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                {!isComplete && !failed && <UploadCloud02 className="text-fg-quaternary size-4 stroke-[2.5px]" />}
                    ...
                    <ButtonUtility color="tertiary" tooltip="Delete" icon={Trash01} size="xs" className="-me-2 -mt-2 self-start" onClick={onDelete} />
                </div>
...
const FileUploadList = ({ children, ...props }: ComponentPropsWithRef<"ul">) => (
    <ul {...props} className={cx("flex flex-col gap-3", props.className)}>
        {/*
         * `AnimatePresence` maps over its children and needs each one to carry a key. Items written
         * as static JSX have none, so two or more would collide on an empty key. `Children.toArray`
         * assigns a stable positional key to every child while preserving any key a caller set.
         */}
