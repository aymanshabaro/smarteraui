...
export interface SidebarNavigationDualTierProps {
...
export const SidebarNavigationDualTier = ({
    ...
    const mainSidebar = (
        <aside aria-label="Sidebar" className="group bg-primary flex h-full max-h-full max-w-full overflow-y-auto">
            <div
                style={
                    {
                ...
                className={cx(
                    "border-secondary relative flex w-full flex-col border-e pt-4 transition duration-300 lg:w-(--width) lg:pt-5",
