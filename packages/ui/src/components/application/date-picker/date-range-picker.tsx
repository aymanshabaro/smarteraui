...
import type { DateRangePickerProps as AriaDateRangePickerProps, DateValue as AriaDateValue } from "react-aria-components";
import {
...
export interface DateRangePickerProps extends AriaDateRangePickerProps<AriaDateValue> {
...
export const DateRangePicker = ({ value: valueProp, defaultValue, onChange, onApply, onCancel, size = "sm", ...props }: DateRangePickerProps) => {
    ...
    const [focusedValue, setFocusedValue] = useState<AriaDateValue | null>(null);
