...
**Definition:** count of non-semantic style literals in the generated files: places the agent reached for a raw value instead of a design-system token or an existing component's built-in variant.
