    ...
    items={[
        {
            ...
            answer: "Run npx properui@latest init --nextjs for a complete setup, or install @properui/ui yourself and import its globals.css from your own stylesheet. Tailwind v4 needs no config file — everything is imported directly in CSS.",
        },
        {
