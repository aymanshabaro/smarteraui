...
<FAQs
    items={[
        ...
        },
        {
            ...
            answer: 'Run npx @properui/cli@latest agent init --client claude. Claude follows repository instructions closely, and the installed Skill\'s explicit "search before writing markup" step is usually all it takes.',
        },
    ]}
/>
