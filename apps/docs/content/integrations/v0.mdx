...
description: "Hand a Proper UI component to v0 and keep iterating on it there: the full source, styles object, and dependencies travel with it."
metaTitle: v0 integration | Proper UI
metaDescription: Open any Proper UI component or example in v0 with one click, or paste its source manually to keep iterating on layout inside v0's chat.
---
...
<FAQs
    items={[
        {
            question: "Does opening a component in v0 install @properui/ui as a dependency?",
        ...
        {
            question: "Can I open a component in v0 without a Proper UI project set up?",
