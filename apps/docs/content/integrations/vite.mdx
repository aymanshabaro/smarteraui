    ...
    items={[
        {
            ...
            answer: "Run npx properui@latest init --vite for a full setup, or install @tailwindcss/vite and @properui/ui yourself and import globals.css from your entry stylesheet. Tailwind v4's Vite plugin replaces the old PostCSS config entirely.",
        },
        {
